...
@Entity
@Table(name = "JEF_BRF_67_DETAIL_TABLE")

public class BRF_67_Detail_Entity {
	...
	public void setAcctBalanceInaed(BigDecimal acctBalanceInpula) {
		this.acctBalanceInaed = acctBalanceInpula;
	}
