...
@Entity
@Table(name = "T8A_PROFILE_NEW_RESPOND_CORRESPONDENT_BANKS")
public class T8AReport {
	...
	private String	CORRESPONDENT_CFT;
	...
	public String getRESPONDENT_CFT() {
		return RESPONDENT_CFT;
	}
	public void setRESPONDENT_CFT(String rESPONDENT_CFT) {
		RESPONDENT_CFT = rESPONDENT_CFT;
	}
	...
	public String getCORRESPONDENT_CFT() {
		return CORRESPONDENT_CFT;
	}
	public void setCORRESPONDENT_CFT(String cORRESPONDENT_CFT) {
		CORRESPONDENT_CFT = cORRESPONDENT_CFT;
	}
	...
	public T8AReport(String rESPONDENT_PRODUCT, BigDecimal rESPONDENT_BANK_COUNT_LOW,
			BigDecimal rESPONDENT_BANK_COUNT_MEDIUM, BigDecimal rESPONDENT_BANK_COUNT_HIGH, String rESPONDENT_CFT,
			String cORRESPONDENT_PRODUCT, BigDecimal cORRESPONDENT_BANK_COUNT_LOW,
			BigDecimal cORRESPONDENT_BANK_COUNT_MEDIUM, BigDecimal cORRESPONDENT_BANK_COUNT_HIGH,
			String cORRESPONDENT_CFT, String rEPORT_CODE, String rEPORT_NAME, Date rEPORT_DATE, Date rEPORT_DUE_DATE,
