...
@Entity
@Table(name = "T13B_PRIVATE_BANK_OUTWARD_DEBIT")
public class T13BReport {
	...
	public T13BReport(String lOW_PRODUCT, BigDecimal lOW_CN_LOW_TRAN_COUNT, BigDecimal lOW_CN_LOW_TRAN_AMT,
