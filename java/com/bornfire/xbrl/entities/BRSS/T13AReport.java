...
@Entity
@Table(name = "T13A_PRIVATE_BANK_INWARD_CREDIT")
public class T13AReport {
	...
	public T13AReport(String lOW_PRODUCT, BigDecimal lOW_CN_LOW_TRAN_COUNT, BigDecimal lOW_CN_LOW_TRAN_AMT,
