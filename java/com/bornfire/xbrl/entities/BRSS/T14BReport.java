...
@Entity
@Table(name = "T14B_THIRD_PARTY_OUTWARD_TRANSACTION")
public class T14BReport {
	...
	public T14BReport(String lOW_PRODUCT, BigDecimal lOW_CN_LOW_TRAN_COUNT, BigDecimal lOW_CN_LOW_TRAN_AMT,
