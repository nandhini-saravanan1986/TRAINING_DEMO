...
@Entity
@Table(name="T35_OR_PATCH_MANAGEMENT_TABLE")
public class T35ORReport {
	...
	private BigDecimal	A2_NETWORK_DEVICES;
	private BigDecimal	A2_NETWORK_DEVICES_WITH_INTERNET;
	private BigDecimal	A2_NON_NETWORK_DEVICES;
	private BigDecimal	A2_NON_NETWORK_DEVICES_WITH_INTERNET;
	...
	private String	A5_NETWORK_DEVICES;
	private String	A5_NETWORK_DEVICES_WITH_INTERNET;
	private String	A5_NON_NETWORK_DEVICES;
	private String	A5_NON_NETWORK_DEVICES_WITH_INTERNET;
	private String	A6_PRODUCT;
	private String	A6_NETWORK_DEVICES;
	private String	A6_NETWORK_DEVICES_WITH_INTERNET;
	private String	A6_NON_NETWORK_DEVICES;
	private String	A6_NON_NETWORK_DEVICES_WITH_INTERNET;
	private String	A7_PRODUCT;
	private String	A7_NETWORK_DEVICES;
	private String	A7_NETWORK_DEVICES_WITH_INTERNET;
	private String	A7_NON_NETWORK_DEVICES;
	private String	A7_NON_NETWORK_DEVICES_WITH_INTERNET;
	...
	public BigDecimal getA2_NETWORK_DEVICES() {
		return A2_NETWORK_DEVICES;
	}
	public void setA2_NETWORK_DEVICES(BigDecimal a2_NETWORK_DEVICES) {
		A2_NETWORK_DEVICES = a2_NETWORK_DEVICES;
	}
	public BigDecimal getA2_NETWORK_DEVICES_WITH_INTERNET() {
		return A2_NETWORK_DEVICES_WITH_INTERNET;
	}
	public void setA2_NETWORK_DEVICES_WITH_INTERNET(BigDecimal a2_NETWORK_DEVICES_WITH_INTERNET) {
		A2_NETWORK_DEVICES_WITH_INTERNET = a2_NETWORK_DEVICES_WITH_INTERNET;
	}
	public BigDecimal getA2_NON_NETWORK_DEVICES() {
		return A2_NON_NETWORK_DEVICES;
	}
	public void setA2_NON_NETWORK_DEVICES(BigDecimal a2_NON_NETWORK_DEVICES) {
		A2_NON_NETWORK_DEVICES = a2_NON_NETWORK_DEVICES;
	}
	public BigDecimal getA2_NON_NETWORK_DEVICES_WITH_INTERNET() {
		return A2_NON_NETWORK_DEVICES_WITH_INTERNET;
	}
	public void setA2_NON_NETWORK_DEVICES_WITH_INTERNET(BigDecimal a2_NON_NETWORK_DEVICES_WITH_INTERNET) {
	...
	public String getA5_NETWORK_DEVICES() {
		return A5_NETWORK_DEVICES;
	}
	public void setA5_NETWORK_DEVICES(String a5_NETWORK_DEVICES) {
		A5_NETWORK_DEVICES = a5_NETWORK_DEVICES;
	}
	public String getA5_NETWORK_DEVICES_WITH_INTERNET() {
		return A5_NETWORK_DEVICES_WITH_INTERNET;
	}
	public void setA5_NETWORK_DEVICES_WITH_INTERNET(String a5_NETWORK_DEVICES_WITH_INTERNET) {
		A5_NETWORK_DEVICES_WITH_INTERNET = a5_NETWORK_DEVICES_WITH_INTERNET;
	}
	public String getA5_NON_NETWORK_DEVICES() {
		return A5_NON_NETWORK_DEVICES;
	}
	public void setA5_NON_NETWORK_DEVICES(String a5_NON_NETWORK_DEVICES) {
		A5_NON_NETWORK_DEVICES = a5_NON_NETWORK_DEVICES;
	}
	public String getA5_NON_NETWORK_DEVICES_WITH_INTERNET() {
		return A5_NON_NETWORK_DEVICES_WITH_INTERNET;
	}
	public void setA5_NON_NETWORK_DEVICES_WITH_INTERNET(String a5_NON_NETWORK_DEVICES_WITH_INTERNET) {
	...
	public String getA6_NETWORK_DEVICES() {
		return A6_NETWORK_DEVICES;
	}
	public void setA6_NETWORK_DEVICES(String a6_NETWORK_DEVICES) {
		A6_NETWORK_DEVICES = a6_NETWORK_DEVICES;
	}
	public String getA6_NETWORK_DEVICES_WITH_INTERNET() {
		return A6_NETWORK_DEVICES_WITH_INTERNET;
	}
	public void setA6_NETWORK_DEVICES_WITH_INTERNET(String a6_NETWORK_DEVICES_WITH_INTERNET) {
		A6_NETWORK_DEVICES_WITH_INTERNET = a6_NETWORK_DEVICES_WITH_INTERNET;
	}
	public String getA6_NON_NETWORK_DEVICES() {
		return A6_NON_NETWORK_DEVICES;
	}
	public void setA6_NON_NETWORK_DEVICES(String a6_NON_NETWORK_DEVICES) {
		A6_NON_NETWORK_DEVICES = a6_NON_NETWORK_DEVICES;
	}
	public String getA6_NON_NETWORK_DEVICES_WITH_INTERNET() {
		return A6_NON_NETWORK_DEVICES_WITH_INTERNET;
	}
	public void setA6_NON_NETWORK_DEVICES_WITH_INTERNET(String a6_NON_NETWORK_DEVICES_WITH_INTERNET) {
	...
	public String getA7_NETWORK_DEVICES() {
		return A7_NETWORK_DEVICES;
	}
	public void setA7_NETWORK_DEVICES(String a7_NETWORK_DEVICES) {
		A7_NETWORK_DEVICES = a7_NETWORK_DEVICES;
	}
	public String getA7_NETWORK_DEVICES_WITH_INTERNET() {
		return A7_NETWORK_DEVICES_WITH_INTERNET;
	}
	public void setA7_NETWORK_DEVICES_WITH_INTERNET(String a7_NETWORK_DEVICES_WITH_INTERNET) {
		A7_NETWORK_DEVICES_WITH_INTERNET = a7_NETWORK_DEVICES_WITH_INTERNET;
	}
	public String getA7_NON_NETWORK_DEVICES() {
		return A7_NON_NETWORK_DEVICES;
	}
	public void setA7_NON_NETWORK_DEVICES(String a7_NON_NETWORK_DEVICES) {
		A7_NON_NETWORK_DEVICES = a7_NON_NETWORK_DEVICES;
	}
	public String getA7_NON_NETWORK_DEVICES_WITH_INTERNET() {
		return A7_NON_NETWORK_DEVICES_WITH_INTERNET;
	}
	public void setA7_NON_NETWORK_DEVICES_WITH_INTERNET(String a7_NON_NETWORK_DEVICES_WITH_INTERNET) {
	...
	public T35ORReport(String a1_PRODUCT, BigDecimal a1_NETWORK_DEVICES, BigDecimal a1_NETWORK_DEVICES_WITH_INTERNET,
			BigDecimal a1_NON_NETWORK_DEVICES, BigDecimal a1_NON_NETWORK_DEVICES_WITH_INTERNET, String a2_PRODUCT,
			BigDecimal a2_NETWORK_DEVICES, BigDecimal a2_NETWORK_DEVICES_WITH_INTERNET,
			BigDecimal a2_NON_NETWORK_DEVICES, BigDecimal a2_NON_NETWORK_DEVICES_WITH_INTERNET, String a3_PRODUCT,
			BigDecimal a3_NETWORK_DEVICES, BigDecimal a3_NETWORK_DEVICES_WITH_INTERNET,
			BigDecimal a3_NON_NETWORK_DEVICES, BigDecimal a3_NON_NETWORK_DEVICES_WITH_INTERNET, String a4_PRODUCT,
			BigDecimal a4_NETWORK_DEVICES, BigDecimal a4_NETWORK_DEVICES_WITH_INTERNET,
			BigDecimal a4_NON_NETWORK_DEVICES, BigDecimal a4_NON_NETWORK_DEVICES_WITH_INTERNET, String a5_PRODUCT,
			String a5_NETWORK_DEVICES, String a5_NETWORK_DEVICES_WITH_INTERNET, String a5_NON_NETWORK_DEVICES,
			String a5_NON_NETWORK_DEVICES_WITH_INTERNET, String a6_PRODUCT, String a6_NETWORK_DEVICES,
			String a6_NETWORK_DEVICES_WITH_INTERNET, String a6_NON_NETWORK_DEVICES,
			String a6_NON_NETWORK_DEVICES_WITH_INTERNET, String a7_PRODUCT, String a7_NETWORK_DEVICES,
			String a7_NETWORK_DEVICES_WITH_INTERNET, String a7_NON_NETWORK_DEVICES,
			String a7_NON_NETWORK_DEVICES_WITH_INTERNET, String a8_PRODUCT, String a8_NETWORK_DEVICES,
			...
			BigDecimal a12_NON_NETWORK_DEVICES_WITH_INTERNET, String rEPORT_CODE, String rEPORT_NAME, Date rEPORT_DATE,
