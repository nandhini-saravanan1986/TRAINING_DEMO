...
import com.bornfire.xbrl.entities.BRSS.BRS2_ENTITY;
...
public class BRS2_ReportService {
	
	
	private static final Logger logger = LoggerFactory.getLogger(BRS2_ReportService.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
		...
		try {
			...
			Long dtlcnt = (Long) hs.createQuery("select count(*) from BRS2_ENTITY a where a.report_date=?1")
					.setParameter(1, dt9).getSingleResult();

			if (dtlcnt > 0) {
				logger.info("Getting No of records in Mod table :" + reportid);
				Long modcnt = (Long) hs.createQuery("select count(*) from BRS2_ENTITY a").getSingleResult();
				if (modcnt > 0) {
					msg = "success";
				}
			} else {
...
public ModelAndView getBRS2_view(String reportId, String fromdate, String todate, String currency, String dtltype,
		Pageable pageable) {
		...
		List<BRS2_ENTITY> T1rep = new ArrayList<BRS2_ENTITY>();
		// Query<Object[]> qr;

		List<BRS2_ENTITY> T1Master = new ArrayList<BRS2_ENTITY>();
		...
		//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
			...
			T1Master = hs.createQuery("from  BRS2_ENTITY a where a.report_date = ?1 ", BRS2_ENTITY .class)
...
public ModelAndView getBRS2currentDtl(String reportId, String fromdate, String todate, String currency,
	...
	mv.setViewName("RR"+"/"+"BRS2::reportcontent");
...
public File getFileBRS2(String reportId, String fromdate, String todate, String currency, String dtltype,
